...
options = {
  ...
  map_frame = "map",
  tracking_frame = "os_imu", -- original: base_link
  published_frame = "base_link",
  odom_frame = "odom",
  provide_odom_frame = true, -- original: false
  publish_frame_projected_to_2d = true,
  use_odometry = false, -- original: true
  use_nav_sat = false,
  use_landmarks = false,
  num_laser_scans = 0,
...
--TRAJECTORY_BUILDER_2D.use_imu_data = false -- original: false
...
--POSE_GRAPH.constraint_builder.sampling_ratio = 0.03  Decrease
